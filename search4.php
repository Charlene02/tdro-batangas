...
if (isset($_GET['term'])) {
    ...
    $sqlInfo = "SELECT * FROM data_info WHERE (TicketNo LIKE '%$searchTerm%' OR Name LIKE '%$searchTerm%') AND status = 'failed'";
} else {
    $sqlInfo = "SELECT * FROM data_info WHERE Status = 'Failed'";
}
