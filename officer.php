      ...
      <span class="button__icon"><svg xmlns="http://www.w3.org/2000/svg" width="24" viewBox="0 0 24 24" stroke-width="2" stroke-linejoin="round" stroke-linecap="round" stroke="currentColor" height="24" fill="none" class="svg"><line y2="19" y1="5" x2="12" x1="12"></line><line y2="12" y1="12" x2="19" x1="5"></line></svg></span>
             ...
             <div class="modal" id="third-modal">
              <div class="modal-header">
                <div class="title">Traffic Citation Form</div>
              </div>
...
<!-- FIRST MODAL -->
   ...
   <div class="box-b" style="width: 1050px; height: 600px;">
     <h2>Forwarded List to City Prosecutor</h2>
     <div class="search-bar">
     ...
     <div class="filter-buttons">
       ...
       <button id="successList"><i aria-hidden="true"></i> Success List</button>
       <button id="failedList"><i aria-hidden="true"></i> Failed List</button>
     </div>
