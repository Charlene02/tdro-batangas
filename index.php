...
<img src="img/background.png" class="img-fluid" style="width: 100px !important; padding-right: 20px " alt="Phone image">
<span class="h1 fw-bold mb-0" style="margin-left: 100px">Log In</span>
</div>
<form method="POST">
<!-- Email input -->
